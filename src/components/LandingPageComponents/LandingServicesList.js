                    ...
                    <div class="tab-pane fade show active" id="nav-carwash" role="tabpanel" aria-labelledby="nav-carwash-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Carwash</h2>
                    ...
                    <div class="tab-pane fade" id="nav-ceramicCoating" role="tabpanel" aria-labelledby="nav-ceramicCoating-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Ceramic Coating</h2>
                    ...
                    <div class="tab-pane fade" id="nav-undercoating" role="tabpanel" aria-labelledby="nav-undercoating-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Undercoating</h2>
                    ...
                    <div class="tab-pane fade" id="nav-interiorDetailing" role="tabpanel" aria-labelledby="nav-interiorDetailing-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Interior Detailing</h2>
                    ...
                    <div class="tab-pane fade" id="nav-exteriorDetailing" role="tabpanel" aria-labelledby="nav-exteriorDetailing-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Exterior Detailing</h2>
                    ...
                    <div class="tab-pane fade" id="nav-engineWash" role="tabpanel" aria-labelledby="nav-engineWash-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Engine Wash</h2>
                    ...
                    <div class="tab-pane fade" id="nav-sanitation" role="tabpanel" aria-labelledby="nav-sanitation-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Sanitation</h2>
                    ...
                    <div class="tab-pane fade" id="nav-waxing" role="tabpanel" aria-labelledby="nav-waxing-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Waxing</h2>
                    ...
                    <div class="tab-pane fade" id="nav-asphaltRemoval" role="tabpanel" aria-labelledby="nav-asphaltRemoval-tab">
                        <div className='container'>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div>
                                        <h2 className='jumbox fs-2 mt-3 mb-3 fw-light' style={{ letterSpacing: '1px' }}>Asphalt Removal</h2>
