                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link onClick={goToAbout} className="options nav-link text-white fs-5">ABOUT</Link>
                            </li>
                            {authUser ? (
                                <li className="nav-item">
                                    <li className="nav-item dropdown">
                                        <a className="options nav-link dropdown-toggle text-info fs-5 fw-normal" style={{ letterSpacing: '1px' }} href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            {authUser.name}
                                        </a>
