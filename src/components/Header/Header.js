        ...
        <nav className="nav container grid">
          <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
            <ul className="nav__list grid">
              ...
              <li className="nav__item">
                <a href="#book" onClick={() => setActiveNav("#book")}
                  className={
                    activeNav === "#book" ? "nav__link active-link" 
                    : "nav__link"
                  }>
              ...
              <li className="nav__item">
                <a href="#reviews" onClick={() => setActiveNav("#reviews")}
                  className={
                    activeNav === "#reviews" ? "nav__link active-link" 
                    : "nav__link"
                  }>
